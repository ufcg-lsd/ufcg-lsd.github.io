...
export const Footer = ({
  ...
  return (
    <div className="flex justify-center w-full bg-black/30">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-(--max-width) px-4 md:px-12 min-h-16 py-16 gap-8">
        ...
        <div className="flex flex-col items-center md:items-end text-white gap-4">
          <h2 className="text-xl font-bold">Redes sociais e contatos</h2>
